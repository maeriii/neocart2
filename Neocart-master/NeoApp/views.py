...
from NeoApp.credentials import MpesaAccessToken, LipanaMpesaPpassword
from NeoApp.models import Transaction, profile
...
def delete(request, id):
    deleteprofile = profile.objects.get(id=id)
